...
public class EffectRegistry {
    ...
    public static final StatusEffect RAGE = register("rage", new CustomStatusEffect(StatusEffectCategory.BENEFICIAL, 0xE81E1E).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_SPEED, "22CCAD68-9108-4ED4-B0B2-F225CE66D0D7", 3.0D, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
